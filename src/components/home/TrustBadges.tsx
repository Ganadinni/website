...
export default function TrustBadges() {
  return (
    <section className="bg-[#143d24] border-t border-white/5 py-12 lg:py-14">
      <div className="container-site">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-4">
          {BADGES.map((b) => (
            <div key={b.title} className="flex flex-col items-center text-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/8 text-[#d4a24e]">
                {b.icon}
              </div>
              <div>
                <div className="text-white font-semibold text-sm leading-snug">{b.title}</div>
                <div className="text-white/50 text-xs mt-0.5 leading-snug">{b.subtitle}</div>
              </div>
            </div>
          ))}
        </div>
