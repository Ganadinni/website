...
export default function BuyBox({ product }: { product: MockProduct }) {
  ...
  const waPackGrams = PACK_GRAMS[pack];
  const _ = waPackGrams; // suppress unused warning
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        <h1
          className="text-3xl font-extrabold leading-tight text-[#1a1412] lg:text-[2.2rem]"
        ...
        <div>
          <div className="mb-2.5 flex items-center justify-between">
            ...
            <p className="text-xs text-[#6b6560]">
              Selected:{' '}
              <span className="font-semibold text-[#1a5c38]">{pack}</span>
            </p>
          </div>
      ...
      {isPremix && (
        <div className="rounded-2xl bg-[#0f3a22] p-5">
          <p className="mb-4 text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#d4a24e]">
            Cost Per Cup — {pack}
          </p>
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="rounded-xl bg-white/[0.07] px-3 py-4">
              <div className="text-2xl font-extrabold text-white">{cups}</div>
              <div className="mt-1 text-[10px] uppercase tracking-wider text-white/50">
                Cups / Pack
              </div>
            </div>
            <div className="rounded-xl bg-white/[0.07] px-3 py-4">
              <div className="text-2xl font-extrabold text-white">₹{cupCost}</div>
              <div className="mt-1 text-[10px] uppercase tracking-wider text-white/50">
                Cost / Cup
              </div>
            </div>
            <div className="rounded-xl border border-[#d4a24e]/30 bg-[#d4a24e]/15 px-3 py-4">
              <div className="text-2xl font-extrabold text-[#d4a24e]">{marginPct}%</div>
              <div className="mt-1 text-[10px] uppercase tracking-wider text-white/50">
                Margin
              </div>
            </div>
          </div>
          <div className="mt-4 flex items-start gap-2 rounded-lg bg-white/[0.05] px-3 py-2.5">
            <svg
              className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#d4a24e]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2.5}
            ...
            <p className="text-[11px] leading-relaxed text-white/50">
              Sell at ₹{sellPrice}/cup → ₹{marginPerCup} margin per cup ·{' '}
              {cups} cups from {pack}
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center gap-2.5 rounded-full bg-[#25D366] px-6 py-4 text-[15px] font-bold text-white transition hover:bg-[#1ebe5d] hover:scale-[1.01]"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center gap-2.5 rounded-full border-2 border-[#1a5c38] px-6 py-4 text-[15px] font-bold text-[#1a5c38] transition hover:bg-[#e8f5ee]"
        >
          Get Bulk Pricing
        </a>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          ...
          <div
            key={text}
            className="flex flex-col items-center gap-1.5 rounded-xl bg-[#f5f1eb] p-3 text-center"
          >
            <span className="text-xl leading-none">{icon}</span>
            <span className="text-[11px] font-semibold leading-tight text-[#6b6560]">
              {text}
            </span>
          </div>
        ))}
